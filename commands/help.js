...
module.exports = {
    ...
    async run (client, message, args){
        ...
        .addField('`*loli`', 'Generates a random loli')
        .addField('`*memeid`', 'Generates a random indonesia meme')
        .setTimestamp()
        ...
        .setTitle('Baru')
        .addField('`*Leaderboard`', 'Cek peringkatmu')
        .addField('`*daily`', 'Mengambil uang harian')
        .addField('`*bal`', 'Melihat jumblah uang')
        .addField('`*covid`', 'Kabar coronavirus')
        .addField('`*Musik maintance`', )
        .setTimestamp()
